...
<ArticleCTA
  title="Want to generate intentional content?"
  description="helps generates SEO optimized content for you in seconds."
  buttonText="Start generating content now!"
/>
...
<ArticleCTA
  title="Ready to Build Your Website’s Authority?"
  description="With miseo, you can create optimized content that attracts backlinks, builds trust, and ranks higher in Google."
  buttonText="👉 Start Growing with miseo"
  showLogo={false}
/>
...
<ArticleCTA
  title="Turn AI Content Into SEO Power"
  description="helps you generate AI-assisted, human-refined articles that are optimized for Google’s EEAT standards."
  buttonText="🚀 Create Smarter Content with miseo"
/>
