...
const SUCCESSMESSAGE = {
  title: 'Thank you!',
  description:
    'We have added you to the waitlist and are in for the discount! We will notify you when the product is available.',
};
const ERRORMESSAGE = 'Something went wrong. Please try again later.';
const TITLE = 'Sign up for early access';
        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 my-10 md:my-20 mx-auto lg:py-0">
          <div className="w-full bg-green-200 rounded-lg shadow-xl dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <p className="text-gray-500 dark:text-gray-400">{SUCCESSMESSAGE.description}</p>
            </div>
          </div>
        </div>
      </section>
